...
function toDay1(){
	...
	$(".day").removeClass('day_D2 day_D3').addClass('day_D1').html('FEB 13');
...
function toDay2(){
	...
	$(".day").removeClass('day_D1 day_D3').addClass('day_D2').html('FEB 14');
...
function toDay3(){
	...
	$(".day").removeClass('day_D1 day_D2').addClass('day_D3').html('FEB 15');
...
function updateTimeline_oat(e){
	Zoom = 0;
	if (pointer) {
		$("#pointer, #pointer-text").fadeOut(400);
		pointer = false;
	};
...
var deadline = new Date('2/13/2016');
